...
namespace Cecilion {
    ...
    template<typename... Events>
    class Application_layer_mt : public  Application_layer<Events...> {
    public:
        Application_layer_mt();

//        ~Application_layer_mt() override = default;
        void attach_to_stack(Layer_stack<Events...>* stack) override;
...
//        void set_previous(Application_layer<Events...>* previous) override;
